...
@if(auth()->check())
    <div class="wrapper">
        <!-- Main Header -->
        <!-- Navbar -->
        <nav id="navID" class="main-header navbar navbar-expand {{setting('fixed_header','')}} {{setting('nav_color','navbar-light bg-white')}} border-bottom"
        @if(setting('language','en') == 'ar')
            style="width: 77%; left: -259px; position: absolute"
        @endif
                >
            <!-- Left navbar links -->
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a
                        @if(setting('language','en') == 'ar')
                        onclick="expandNav(), expandBody(), expandFooter(), fadeSidebar()"
                        @endif
                        class="nav-link" data-widget="pushmenu" href="#"><i class="fa fa-bars"></i></a>
                </li>
        ...
        @if(setting('language','en') == 'ar')
            <div style="display: flex; flex-direction: column;">
                <div>
                    ...
                    <div id="bodyID" style="width: 77%; float: left; margin: 80px 10px;">
                        @yield('content')
                    </div>
                </div>
                <footer id="footerID" class="main-footer"
                style="position: absolute!important; width: 77%; left: -259px; bottom: 0;">
...
@else
    ...
    <script type="text/javascript">
        ...
        function expandFooter()
        {
            ...
            if (footer.style.width === "1385px") {
                footer.style.width = "992px";
                footer.style.transition = "width 0.3s ease-in-out";
            }
            else {
                footer.style.width = "1385px";
                footer.style.transition = "width 0.3s ease-in-out";
            }
        }
        function expandBody()
        {
            ...
            if (bdy.style.width === "1190px") {
                bdy.style.width = "992px";
                bdy.style.transition = "width 0.3s ease-in-out";
            }
            else {
                bdy.style.width = "1190px";
                bdy.style.transition = "width 0.3s ease-in-out";
            }
        }
        function expandNav()
        {
            ...
            if (nav.style.width === "1385px") {
                nav.style.width = "992px";
                nav.style.transition = "width 0.3s ease-in-out";
            }
            else {
                nav.style.width = "1385px";
                nav.style.transition = "width 0.3s ease-in-out";
            }
        }
